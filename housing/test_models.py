...
from models import Apartment, Flat, User, Interested, TenantsRights
...
class InterestedModelTests(TestCase):  # Interested模型的测试代码
    ...
    def test_do_nothing_delete_on_apartment(self):  # Tests the behavior when an Apartment is deleted.
        ...
        self.assertEqual(Interested.objects.count(), 1)  # Asserts that the Interested record still exists after the Apartment is deleted.
